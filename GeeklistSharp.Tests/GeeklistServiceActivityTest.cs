...
namespace GeeklistSharp.Tests
{
    ...
    public class GeeklistServiceActivityTest : GeeklistBaseTest
    {
        ...
        public void ActivitiesDeserializeTest()
        {
            ...
            var serializer = new DataContractJsonSerializer(typeof(Response<List<Activity>>));

            MemoryStream memoryStream = new System.IO.MemoryStream(System.Text.Encoding.UTF8.GetBytes(testActivitysJson));

            var result = serializer.ReadObject(memoryStream) as Response<List<Activity>>;
